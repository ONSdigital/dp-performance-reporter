...
sed dp-performance-reporter/appspec.yml dp-performance-reporter/scripts/codedeploy/* -i \
...
cp dp-performance-reporter/appspec.yml artifacts/
cp dp-performance-reporter/scripts/codedeploy/* artifacts/scripts/codedeploy
